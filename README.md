# USPS Tracking API For Nodejs
USPS Tracking API and webhook make it easy to integrate USPS Tracking function into your own project. Support APIs Client Libraries for nodejs

### API key

In order to use this API, you need to generate a USPS Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use USPS Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [USPS Tracking API](https://www.trackingmore.com/usps-tracking.html)  to:

   *   Get USPS realtime tracking info of muti-carriers in one integration
   *   Provide USPS shipment tracking experience like Amazon
   *   Push USPS notifications of package update with webhook
   *   Verify USPS delivery exception before it is too late
